...
@WebServlet("/signup/add_gallery_db")
public class AddGalleyServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		String repreName = request.getParameter("repreName");
		...
		String galleryNumber1 = request.getParameter("galleryNumber1");
		String galleryNumber2 = request.getParameter("galleryNumber2");
		String galleryNumber3 = request.getParameter("galleryNumber3");
